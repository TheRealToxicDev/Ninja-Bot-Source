...
exports.run = (client, message, args) => {
      ...
      if (ms.size === 1) { ms.first().delete(); return message.channel.send("**[★ Ninja ★] messages have been deleted**") }
      if (ms.size < 1) return message.channel.send("**No messages found to clean**")
      message.channel.bulkDelete(ms, true).then(() => message.channel.send("**[★ Ninja ★] messages have been deleted**"))
  })
}
